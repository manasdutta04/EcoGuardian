    ...
    <footer className="bg-gray-900 text-white relative">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            <div className="flex items-center">
              <div className="p-2 rounded-lg bg-primary-dark/30 mr-3">
              ...
              <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary-light to-primary">EcoGuardian</h2>
            </div>
            ...
            <div className="mt-6">
              ...
              <a href="mailto:info@ecoguardian.org" className="flex items-center text-gray-400 hover:text-white mt-2 transition-colors duration-300 group">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-primary group-hover:text-primary-light transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-200 border-b border-gray-800 pb-2">Features</h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-primary group-hover:text-primary-light transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-200 border-b border-gray-800 pb-2">Resources</h3>
            <ul className="space-y-3">
              {[
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-200 border-b border-gray-800 pb-2">Connect</h3>
            <div className="flex space-x-4 mb-6">
              {[
                ...
                <a
                  ...
                  className="text-gray-400 hover:text-white transition-colors duration-300 p-2 rounded-full hover:bg-primary/20"
              ...
              <form className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="w-full px-4 py-2 placeholder-gray-500 focus:ring-primary focus:border-primary border-gray-700 rounded-lg bg-gray-700 text-white text-sm"
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-primary to-primary-dark border border-transparent rounded-lg py-2 px-4 flex items-center justify-center text-white hover:from-primary-dark hover:to-primary transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-offset-gray-800"
                  >
                    Subscribe
                  </button>
                </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-gray-400">&copy; {currentYear} EcoGuardian. All rights reserved.</p>
